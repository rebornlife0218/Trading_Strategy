...
# FED宣布降息的時間為台灣時間，且開盤前已知
cut_dates = pd.to_datetime(['2001-01-03', '2001-01-31', '2001-03-20', '2002-11-06', '2001-04-18', '2001-05-15', '2001-06-27', '2001-08-21', '2001-09-17',
                            '2001-10-02', '2001-11-06', '2001-12-11', '2002-11-06', '2003-06-25', '2007-09-18', '2007-10-31', '2007-12-11', '2008-01-22',
                            '2008-01-30', '2008-03-18',  '2008-04-30', '2008-10-08', '2008-10-29', '2019-08-01', '2019-09-19', '2019-10-31', '2020-03-03',
                            '2020-03-15', '2024-09-19', '2024-11-08', '2024-09-19', '2024-11-08', '2024-12-19'])
cut_returns = {}
d = 10
...
for date in cut_dates:
    ...
    if not idx.empty:
        ...
        # 儲存到字典
        cut_returns[date.strftime('%Y-%m-%d')] = {
            'Pre_days': {
...
# 印出結果
for date, data in cut_returns.items():
    print(f"Cut Rate Date: {date}")
...
# 計算降息前後的總報酬、平均報酬、Sharpe Ratio、Win Rate、Max Drawdown
pre_returns = [data['Pre_days']['Return'] for data in cut_returns.values()]
post_returns = [data['Post_days']['Return'] for data in cut_returns.values()]
...
# 計算降息前d天和後d天的各項指標
pre_metrics = calculate_metrics(pre_returns)
post_metrics = calculate_metrics(post_returns)

print("Pre-cut period:")
